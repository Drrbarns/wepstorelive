...
export default function Checkout({
  ...
  // Payment form state - default to first enabled method
  const getDefaultPaymentMethod = () => {
    const methods = Object.keys(enabledPaymentMethods);
  ...
  const handlePlaceOrder = async () => {
    ...
    if (paymentMethod === 'cashfree') {
      await handleCashfreeOrderPlacement(orderData, storeSlug, (error: string) => {
      ...
      await handleRazorpayOrderPlacement(
        ...
        (orderNumber: string) => {
          ...
          window.location.href = route('store.order-confirmation', {
            storeSlug,
            orderNumber
          });
        },
        ...
        <div className="bg-gray-50 py-4">
          <div className="container mx-auto px-4">
            <div className="flex items-center text-sm">
              <Link href={route('store.home', { storeSlug })} className="text-gray-500 hover:text-primary">Home</Link>
              <ChevronRight className="h-4 w-4 mx-2 text-gray-400" />
              <Link href={route('store.cart', { storeSlug })} className="text-gray-500 hover:text-primary">Cart</Link>
              <ChevronRight className="h-4 w-4 mx-2 text-gray-400" />
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className={`block w-full pl-10 pr-3 py-2 border ${shippingErrors.shippingFirstName ? 'border-red-500' : 'border-gray-300'
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-3 py-2 border ${shippingErrors.shippingLastName ? 'border-red-500' : 'border-gray-300'
                              } rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary`}
                          />
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className={`block w-full pl-10 pr-3 py-2 border ${shippingErrors.shippingEmail ? 'border-red-500' : 'border-gray-300'
                                } rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary`}
                            />
                          </div>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className={`block w-full pl-10 pr-3 py-2 border ${shippingErrors.shippingPhone ? 'border-red-500' : 'border-gray-300'
                                } rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary`}
                            />
                          </div>
                        ...
                        <div className="md:col-span-2">
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className={`block w-full pl-10 pr-3 py-2 border ${shippingErrors.shippingStreet ? 'border-red-500' : 'border-gray-300'
                                } rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary`}
                            />
                          </div>
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className={`block w-full px-3 py-2 border ${shippingErrors.shippingState ? 'border-red-500' : 'border-gray-300'
                              } rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary`}
                          >
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className={`block w-full px-3 py-2 border ${shippingErrors.shippingCity ? 'border-red-500' : 'border-gray-300'
                              } rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary`}
                          >
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`block w-full px-3 py-2 border ${shippingErrors.shippingZip ? 'border-red-500' : 'border-gray-300'
                              } rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary`}
                          />
                    ...
                    <form onSubmit={handlePaymentSubmit} className="p-6">
                      ...
                      <div className="mb-8">
                        ...
                        <div className="space-y-4">
                          ...
                          {Object.entries(enabledPaymentMethods).filter(([method]) => !['cod', 'whatsapp', 'telegram'].includes(method)).map(([method, config]: [string, any]) => {
                            ...
                            return (
                              <div key={method} className="relative bg-white border rounded-md shadow-sm p-4 flex">
                                <div className="flex items-center h-5">
                                  <input
                                    id={`payment-${method}`}
                                    name="payment-method"
                                ...
                                <label htmlFor={`payment-${method}`} className="ml-3 flex flex-col cursor-pointer">
                                  ...
                                  <span className="block text-sm text-gray-500">
                                    Pay securely with {methodNames[method] || method}
                                  </span>
                                </label>
                              </div>
                            );
                            ...
                            <div>
                              ...
                              <div className="relative">
                                ...
                                <input
                                  ...
                                  className={`block w-full pl-10 pr-3 py-2 border ${paymentErrors.whatsappNumber ? 'border-red-500' : 'border-gray-300'
                                    } rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary`}
                                />
                              </div>
