        ...
        <section id="features" className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
                ...
                <h2 className="text-4xl md:text-6xl font-display font-bold text-gray-900 tracking-tight">
                    Celebrate our launch with <br /> unbeatable <span className="text-highlight-blue cursor-default">savings</span>.
                </h2>
                <p className="mt-6 text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
                    We are offering a massive 58% discount on all plans. This exclusive offer is available from January 15th, 2025 to February 3rd, 2026.
                </p>
            </div>
                ...
                <div className="bg-accent-light rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden min-h-[600px] group transition-all duration-500 hover:shadow-xl border border-blue-100/50">
                    <div className="relative z-10 max-w-md">
                        ...
                        <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight">
                            Get 58% Off <br /> <span className="text-primary">Everything.</span>
                        </h3>
                        <p className="text-gray-600 mb-8 text-lg leading-relaxed">
                            Don't miss this opportunity. Secure premium features for less during our launch period. Valid from Jan 15, 2025 - Feb 3, 2026.
                        </p>
