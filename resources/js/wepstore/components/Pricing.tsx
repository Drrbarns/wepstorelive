    ...
    <section id="pricing" className="bg-dark py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          {annual && <div className="text-primary text-sm font-bold mt-3 animate-fade-in-up">Save 58% on yearly billing</div>}
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-7xl mx-auto">
          {plans.map((plan, index) => {
            ...
            // Calculate yearly price: Monthly * 12 * discount (58% discount applied)
